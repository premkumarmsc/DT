...
@interface ExciSubCatViewController ()
{
...
@implementation ExciSubCatViewController
...
- (void)viewDidLoad
{
    ...
    NSString *catNd = [[NSUserDefaults standardUserDefaults]stringForKey:@"CAT_NAME"];
    
    _topLabel.text = catNd;
...
-(void)gedatas
{
    ...
    NSMutableDictionary *parameters = [[NSMutableDictionary alloc]init];
    [parameters setObject:[NSString stringWithFormat:@"%@",catId] forKey:@"e_catid"];
    [parameters setObject:[NSString stringWithFormat:@"%@",exiId] forKey:@"exhibition_id"];
    

    NSLog(@"Params:%@",parameters);
    
    NSString *urlString=[NSString stringWithFormat:@"%@allexhibitionsubcategories",ApiBaseURL];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    ExciListViewController *dashObj =[[ExciListViewController alloc]init];
