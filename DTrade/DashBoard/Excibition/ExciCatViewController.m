...
@interface ExciCatViewController ()
{
...
@implementation ExciCatViewController
...
- (void)viewDidLoad
{
    ...
    NSString *catId = [[NSUserDefaults standardUserDefaults]stringForKey:@"EXI_NAME"];
...
-(void)gedatas
{
    ...
    NSString *urlString=[NSString stringWithFormat:@"%@allexhibitioncategories",ApiBaseURL];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    ExciSubCatViewController *dashObj =[[ExciSubCatViewController alloc]init];
