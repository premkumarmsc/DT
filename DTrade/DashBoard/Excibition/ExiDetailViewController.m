...
@interface ExiDetailViewController ()
{
...
@implementation ExiDetailViewController
...
-(void)getDatas
{
    ...
    NSString *urlString=[NSString stringWithFormat:@"%@exhibition_stall_details",ApiBaseURL];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    if (indexPath.section == 0)
    {
        ...
        cell1.addCommentFld.hidden = YES;
        cell1.lblCommendsLbl.hidden = YES;
